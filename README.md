...
Привет! Это улучшенная версия бота для Telegram, который умеет превращать голосовые сообщения, видео и аудио в текст. 

## 🚀 Что нового в версии 2?

- 🎯 Оптимизированные промпты для Claude Haiku с XML-структурой
